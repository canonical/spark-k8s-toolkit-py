...
class K8sServiceAccountRegistry(AbstractServiceAccountRegistry):
    ...
    def _retrieve_configuration_hub_configurations(
        self, name: str, namespace: str
    ) -> PropertyFile:
        secret_name = self._get_configuration_hub_secret_name(name)
        ...
        return configuration_hub_properties
    ...
    def _build_service_account_from_raw(self, metadata: Dict[str, Any]):
        ...
        return ServiceAccount(
            ...
            hub_confs=self._retrieve_configuration_hub_configurations(name,namespace)
        )
