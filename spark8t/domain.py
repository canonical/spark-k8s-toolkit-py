...
class ServiceAccount:
    ...
    @property
    def configurations_with_hub(self) -> PropertyFile:
        """Return the service account configuration, associated to a given spark service account with the ones generated by the Spark Configuration Hub."""
        return (
            self.configuration_hub_confs + self.extra_confs + self._k8s_configurations
        )
